...
from plot import setup_plot, update_plot, plot_final_path, plot_rewards_parallel, plot_rewards_time_parallel
...
def mcts_run_parallel_tree_virtual_loss(graph: OrienteeringGraph, start_node_index=0, num_simulations=31250, num_threads=16):
    ...
    # plot_final_path(ax, G, pos, graph, best_node.path, filename=f"final_paths/final_path_parallel_tree_budget_{graph.budget}.png")
    
    #Plot rollout rewards
    plot_rewards_parallel(ordered_rewards, filename=f"logs/parallel_tree_virtual_loss/threads/results/threads_{num_threads}_budget_{graph.budget}_simulations_{num_simulations*num_threads}.png", step=12500)
    ...
    #Plot Time Rewards
    plot_rewards_time_parallel(time_log, ordered_rewards, filename=f"logs/parallel_tree_virtual_loss/threads/results_time/threads_{num_threads}_budget_{graph.budget}_simulations_{num_simulations*num_threads}.png", step=12500)
