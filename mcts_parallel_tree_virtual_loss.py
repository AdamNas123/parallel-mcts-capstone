...
def mcts_run_parallel_tree_virtual_loss(graph: OrienteeringGraph, start_node_index=0, num_simulations=62500, num_threads=4):
    ...
    plot_rewards_parallel(ordered_rewards, filename=f"logs/parallel_tree_virtual_loss/results/budget_{graph.budget}_simulations_{num_simulations*num_threads}.png", step=6250)
