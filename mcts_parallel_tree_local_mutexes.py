...
def mcts_run_parallel_tree_local_mutex(graph: OrienteeringGraph, start_node_index=0, num_simulations=7813, num_threads=64):
    ...
    plot_rewards_parallel(ordered_rewards, filename=f"logs/parallel_tree_local_mutex/threads/results/threads_{num_threads}_budget_{graph.budget}_simulations_{num_simulations*num_threads}.png", step=12500)
    # averaged_rewards = [sum(rewards) / len(rewards) for rewards in all_rewards_over_time]
    # plot_rewards_average(thread_rewards, averaged_rewards, filename=f"logs/parallel_tree_local_mutex/results/budget_{graph.budget}_simulations_{num_simulations*num_threads}.png", step=5000)
   
    #Plot Time Rewards
    plot_rewards_time_parallel(time_log, ordered_rewards, filename=f"logs/parallel_tree_local_mutex/threads/results_time/threads_{num_threads}_budget_{graph.budget}_simulations_{num_simulations*num_threads}.png", step=12500)
